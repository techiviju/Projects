		...
		<div class="row g-4 justify-content-center">
			<div class="col-12 col-sm-6 col-md-4 col-lg-3">
				<div class="card my-card team-card text-center">
					...
					<div class="card-body">
						<h5 class="fw-bold myP-color">Dr. Naresh</h5>
			...
			<div class="col-12 col-sm-6 col-md-4 col-lg-3">
				<div class="card my-card team-card text-center">
					...
					<div class="card-body">
						<h5 class="fw-bold myP-color">Dr. Shankar</h5>
			...
			<div class="col-12 col-sm-6 col-md-4 col-lg-3">
				<div class="card my-card team-card text-center">
					...
					<div class="card-body">
						<h5 class="fw-bold myP-color">Dr. Sakshi</h5>
			...
			<div class="col-12 col-sm-6 col-md-4 col-lg-3">
				<div class="card my-card team-card text-center">
					...
					<div class="card-body">
						<h5 class="fw-bold myP-color">Dr. Ruteeka</h5>
