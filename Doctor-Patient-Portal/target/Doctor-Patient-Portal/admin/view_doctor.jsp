			...
			<div class="col-md-12">
				...
				<div class="card my-card">
					...
					<div class="card-body p-md-5 p-3">
						...
						<div class="text-center text-muted py-4">No doctor records
							found in the system.</div>
								...
								<tbody>
									...
									<tr>
										...
										<td class="text-center"><a
											...
											href="edit_doctor.jsp?id=<%=doctorLst.getId()%>">Edit</a> <a
											class="btn btn-sm btn-danger action-btn"
											href="../deleteDoctor?id=<%=doctorLst.getId()%>">Delete</a>
							...
							<div class="doctor-card">
								...
								<div class="card-action">
									...
									<a class="btn btn-primary action-btn"
										href="edit_doctor.jsp?id=<%=doctorLst.getId()%>"> <i
										class="fa-solid fa-edit me-1"></i> Edit

									</a> <a class="btn btn-danger action-btn"
										href="../deleteDoctor?id=<%=doctorLst.getId()%>"> <i
										class="fa-solid fa-trash-alt me-1"></i> Delete
